		...
		<div class="container">
			...
			<div class="agileits_w3layouts-contact">
				...
				<div class="col-md-6 col-sm-12  agileits_w3layouts-map">
					<iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJZW0tiH3BwjsRfqy5rXJPpr8&key=AIzaSyCcxFmpUbBH5TL4TUmIReRtLk0TeGkebGg" allowfullscreen></iframe>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
...
<script src="js/owl.carousel.js"></script>  
	<script>
		$(document).ready(function() { 
			...
			//Call API to get the services information and render it onto UI
...
<div class="w3_agileits-footer">
	<div class="container">
		<div class="col-md-9 col-sm-12 wthree-footer-left">
			<div class="navbar-header page-scroll">
				<h2><a class="navbar-brand" href="index.html"><i class="fa fa-angle-double-right w3-logo" aria-hidden="true"></i>Only Docs<i class="fa fa-fighter-jet w3-logo" aria-hidden="true"></i></a></h2>
				<P>We make india digital</P>
			</div> 		
		</div>
